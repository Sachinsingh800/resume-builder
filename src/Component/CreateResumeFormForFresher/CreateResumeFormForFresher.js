...
const CreateResumeFormForFresher = () => {
  ...
  const [handleSuggestion, setHandleSuggestion] =
    useRecoilState(suggestionData);
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append(
      "volunteerExperience",
      JSON.stringify(resume.volunteerExperience)
    );
      ...
      <form className={style.form}>
            ...
            {resume.education.map((education, index) => (
              <div key={index}>
                ...
                <div className={style.section_2}>
                  ...
                  <div>
                    <label htmlFor={`collegeName-${index}`}>
                      College Name:
                    </label>
                    <input
                      type="text"
        ...
        {section === 4 && (
          <section>
            ...
            {resume.skillsAndLevel.map((skill, index) => (
              <div key={index}>
                <h2>
                  Skills and Level {index + 1}
                  <div className={style.dele_btn}>
                    {resume.skillsAndLevel.length > 0 && (
                      <button onClick={(e) => handleDeleteSkills(index, e)}>
                        <AiFillDelete />
                      </button>
                    )}
                  </div>
                ...
                <h2>
                  ...
                  <div className={style.dele_btn}>
                    {resume.internShips.length > 0 && (
                      <button onClick={() => handleDeleteInternship(index)}>
                        <AiFillDelete />
                      </button>
                    )}
                  </div>
        ...
        {section === 9 && (
          <section className={style.section_9}>
            ...
            <div className={style.add_btn}>
              <button onClick={handleAddCertification}>+</button>
            </div>
          </section>
        )}
            ...
            {resume.volunteerExperience.map((volunteer, index) => (
              <div key={index}>
                <h2 className={style.section_11_h2}>
                  ...
                  <div className={style.dele_btn}>
                    {resume.volunteerExperience.length > 0 && (
                      <button onClick={() => handleDeleteVolunteer(index)}>
                        <AiFillDelete />
                      </button>
                    )}
                  </div>
                ...
                <div className={style.section_11}>
                  ...
                  <div>
                    <label htmlFor={`volunteerCompany-${index}`}>
                      Company:
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor={`volunteerStartDate-${index}`}>
                      Start Date:
                    </label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label htmlFor={`volunteerEndDate-${index}`}>
                      End Date:
                    </label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label htmlFor={`volunteerLocation-${index}`}>
                      Location:
                    </label>
                    <input
                      type="text"
                ...
                <br />
                <div>
                  <label htmlFor={`volunteerDescription-${index}`}>
                    Description:
                  </label>
                  <textarea
                ...
                <h2 className={style.section_12_h2}>
                  ...
                  <div className={style.dele_btn}>
                    {resume.areaOfInterest.length > 1 && (
                      <button onClick={() => handleDeleteInterest(index)}>
                        <AiFillDelete />
                      </button>
                    )}
                  </div>
                ...
                <h2 className={style.section_13_h2}>
                  ...
                  <div className={style.dele_btn}>
                    {resume.references.length > 1 && (
                      <button onClick={() => handleDeleteReference(index)}>
                        <AiFillDelete />
                      </button>
                    )}
                  </div>
