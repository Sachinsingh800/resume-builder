...
import { Divider, containerClasses } from "@mui/material";
...
const Template_26 = () => {
  ...
  return (
    <div  onClick={()=>setTemplateNo(25)}  className={style.main}>
      ...
      <div className={style.container}>
        <div className={style.container_section1}>
          ...
          <div className={style.section}>
            ...
            <div className={style.work_entrys}>
        ...
        <br/>
        <Divider sx={{marginLeft:"13px",width:"50rem"}} />
        <br/>
        <div className={style.section}>
