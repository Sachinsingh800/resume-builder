        ...
        >
          ...
          <div className={style.section}>
            ...
            <ul className={style.skills_list}>
              <li><span>javascript</span> <span className={style.ProgressBar_list}><ProgressBar bgcolor="black" progress={100} height={5} /></span></li>
              <li><span>javascript</span> <span className={style.ProgressBar_list}><ProgressBar bgcolor="black"  progress={70}  height={5} /></span></li>
              <li><span>javascript</span> <span className={style.ProgressBar_list}><ProgressBar bgcolor="black" progress={30}   height={5} /></span></li>
              <li><span>javascript</span> <span className={style.ProgressBar_list}><ProgressBar bgcolor="black" progress={70}   height={5} /></span></li>
              <li><span>javascript</span> <span className={style.ProgressBar_list}><ProgressBar bgcolor="black" progress={50}  height={5} /></span></li>
