...
const BlogLayout = () => {
  ...
  const filteredBlog = blogs.find((item) => formatTitleForUrl(item.blogData.Section1.title) === title);

  const sortedSections = filteredBlog ? Object.keys(filteredBlog.blogData)
    ...
    <>
      ...
      <div className="container">
        <div className="left">
          ...
          <nav>
            <ul>
              {filteredBlog && sortedSections.map((section, index) => (
              ...
              <>
                ...
                <Element name={section} key={section}>
                  ...
                  {filteredBlog.blogData[section].url && (
                    <img src={filteredBlog.blogData[section].url} alt={filteredBlog.blogData[section].title} />
                  )}
                  {filteredBlog.blogData[section].description && (
                    <div dangerouslySetInnerHTML={{ __html: filteredBlog.blogData[section].description }}></div>
                  )}
                </Element>
        ...
        <div className="right">
          <div className="share">
            ...
            <br/>
            <ul>
              <li><a href="#!">< AiOutlineTwitter /></a>
              <span >129</span>
              </li>
              <li><a href="#!"><AiFillLinkedin /></a>
              <span >32</span>
              </li>
              <li><a href="#!"><BsFacebook /></a>
              <span >12</span>
              </li>
              <li><a href="#!"><AiFillInstagram /></a>
              <span >123</span>
              </li>
            </ul>
          </div>
      ...
      <div className="blogContainer">
        {blogs.map((blog, index) => (
          <div key={index} className="blogCard" onClick={()=>window.location.href=`/blog-layout/${formatTitleForUrl(blog?.blogData?.Section1?.title)}`}>
            ...
            <div className="blogDetails">
              ...
              <p className="des" dangerouslySetInnerHTML={{ __html: blog.blogData.Section1.description }}></p>
            </div>
          </div>
        ))}
      </div>
